...
public class BTTestBean implements BTTestRemote {
	...
	public BTTestBean(String name) {
		this.name = name;
	}

	public String txRequired(String arg) {
		return handleRequest("txRequired", arg);
	}

	public String txSupports(String arg) {
		return handleRequest("txSupports", arg);
	}

	public String txMandatory(String arg) {
		return handleRequest("txMandatory", arg);
	}

	public String txNever(String arg) {
		return handleRequest("txNever", arg);
	}

	public String txRequiresNew(String arg) {
		return handleRequest("txRequiresNew", arg);
	}

	public String txNotSupported(String arg) {
		return handleRequest("txNotSupported", arg);
	}

	public String echo(String arg) {
		return handleRequest("echo", arg);
	}
			...
			for (Map.Entry<String, String> e : map.entrySet()) {
				if ("bean".equals(e.getKey())) {
					try {
						...
						return e.getKey() + " is not a valid bean name: "
								+ ex.getMessage();
					}
