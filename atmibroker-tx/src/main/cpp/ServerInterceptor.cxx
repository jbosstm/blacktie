...
log4cxx::LoggerPtr atmiServerInterceptorLogger(log4cxx::Logger::getLogger("TxLogServerInterceptor"));
...
ServerInterceptor::ServerInterceptor(const char *orbname, IOP::CodecFactory_var cf) :
	...
	FTRACE(atmiServerInterceptorLogger, "ENTER");
}
...
void ServerInterceptor::send_exception(PortableInterceptor::ServerRequestInfo_ptr ri) {
	...
	//LOG4CXX_LOGLS(atmiServerInterceptorLogger, log4cxx::Level::getTrace(), (char *) "exception: " << ri->sending_exception());
	LOG4CXX_LOGLS(atmiServerInterceptorLogger, log4cxx::Level::getTrace(), (char *) "send_exception: ");
