...
log4cxx::LoggerPtr HybridSessionImpl::logger(
		log4cxx::Logger::getLogger("HybridSessionImpl"));

HybridSessionImpl::HybridSessionImpl(char* connectionName, apr_pool_t* pool, int id,
		char* serviceName) {
	...
	this->toRead = new HybridEndpointQueue(this->pool, connectionName, id);
