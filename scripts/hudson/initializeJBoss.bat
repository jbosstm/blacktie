...
echo        ^</move^> >> build.xml
echo        ^<get src="http://albany/userContent/blacktie/jboss-5.1.0.GA.zip" dest="./jboss-5.1.0.GA.zip" verbose="true" usetimestamp="true" skipexisting="true"/^> >> build.xml
echo        ^<get src="http://albany/userContent/blacktie/hornetq-2.1.2.Final.zip" dest="./hornetq-2.1.2.Final.zip" verbose="true" usetimestamp="true" skipexisting="true"/^> >> build.xml
echo        ^<get src="http://albany/userContent/blacktie/jbossesb-4.9.zip" dest="./jbossesb-4.9.zip" verbose="true" usetimestamp="true" skipexisting="true"/^> >> build.xml
