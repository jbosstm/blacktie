...
echo        ^<replaceregexp byline="true" file="jboss-5.1.0.GA/server/all-with-hornetq/deploy/hornetq.sar/hornetq-jms.xml" match="InVMConnectionFactory&quot;&gt;" replace="InVMConnectionFactory&quot;&gt;&lt;connection-ttl&gt;-1&lt;/connection-ttl&gt;"  /^> >> build.xml
echo	^</target^> >> build.xml
