...
(cd c:\Documents and Settings\hudson\.m2\repository\org\codehaus\stomp\stompconnect\1.0.1-BT\ && %J_ARTIFACT% -DpomFile=stompconnect-1.0.1-BT.pom -Dverion=1.0.1-BT -Dfile=stompconnect-1.0.1-BT.jar && $J_ARTIFACT -Dpackaging=java-source -DpomFile=stompconnect-1.0.1-BT.pom -Dverion=1.0.1-BT -Dfile=stompconnect-1.0.1-BT-src.zip)
