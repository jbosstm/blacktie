...
import AtmiBroker.TypedBufferMember;
...
public class JABMessage implements Message {
	...
	private List<AtmiBroker.TypedBufferMember> members = new ArrayList<AtmiBroker.TypedBufferMember>();
	private int size;
	...
	public void deleteItem(String name, int itemNo) {
		log.debug("JABTypedBuffer deleteItem name: " + name + " occurence:" + itemNo);
		Iterator<TypedBufferMember> iterator = members.iterator();
		int count = 0;
		while (iterator.hasNext()) {
			TypedBufferMember next = iterator.next();
	...
	public byte getByteItemDef(String name, int itemNo, byte val) {
		log.debug("JABTypedBuffer getByteItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public byte[] getBytesItemDef(String name, int itemNo, byte[] val) {
		log.debug("JABTypedBuffer getBytesItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public boolean getBooleanItemDef(String name, int itemNo, boolean val) {
		log.debug("JABTypedBuffer getBooleanItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public char getCharItemDef(String name, int itemNo, char val) {
		log.debug("JABTypedBuffer getCharItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public double getDoubleItemDef(String name, int itemNo, double val) {
		log.debug("JABTypedBuffer getDoubleItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public float getFloatItemDef(String name, int itemNo, float val) {
		log.debug("JABTypedBuffer getFloatItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public int getIntItemDef(String name, int itemNo, int val) {
		log.debug("JABTypedBuffer getIntItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public short getShortItemDef(String name, int itemNo, short val) {
		log.debug("JABTypedBuffer getShortItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public long getLongItemDef(String name, int itemNo, long val) {
		log.debug("JABTypedBuffer getLongItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public String getStringItemDef(String name, int itemNo, String val) {
		log.debug("JABTypedBuffer getStringItemDef name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setByteItem(String name, int itemNo, byte val) {
		log.debug("JABTypedBuffer setByteItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setBytesItem(String name, int itemNo, byte[] val) {
		log.debug("JABTypedBuffer setBytesItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setBooleanItem(String name, int itemNo, boolean val) {
		log.debug("JABTypedBuffer setBooleanItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setCharItem(String name, int itemNo, char val) {
		log.debug("JABTypedBuffer setCharItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setDoubleItem(String name, int itemNo, double val) {
		log.debug("JABTypedBuffer setDoubleItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setFloatItem(String name, int itemNo, float val) {
		log.debug("JABTypedBuffer setFloatItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setIntItem(String name, int itemNo, int val) {
		log.debug("JABTypedBuffer setIntItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setShortItem(String name, int itemNo, short val) {
		log.debug("JABTypedBuffer setShortItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setLongItem(String name, int itemNo, long val) {
		log.debug("JABTypedBuffer setLongItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
	...
	public void setStringItem(String name, int itemNo, String val) {
		log.debug("JABTypedBuffer setStringItem name: " + name + " occurence:" + itemNo);
		int i = 0;
		int count = 0;
		for (i = 0; i < members.size(); i++) {
			if (name.equals(members.get(i).name)) {
